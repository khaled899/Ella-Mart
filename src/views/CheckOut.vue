    ...
    <v-container fluid class="ma-0 pa-0">
      <v-row>
        <v-col cols="12" md="6" lg="7">
          ...
          >
            <v-card-title style="font-weight: bold" class="py-0">
              Ella Mart
            </v-card-title>

            <v-breadcrumbs style="font-size: 12px">
              <v-breadcrumbs-item
            ...
            <v-card-title
              class="text-center"
              style="font-size: 14px; color: #878484"
              >Express Checkout</v-card-title
            >
            <v-card-actions class="justify-center align-center mb-3">
              <v-btn
                color="#6200ff"
                variant="elevated"
                class="flex-grow-1"
            ...
            <div class="second-info">
              <p class="or" style="font-size: 14px; color: #878484">OR</p>
            </div>
            <v-card-title
              class="mt-3"
              style="font-size: 17px; font-weight: 700; color: #484848"
              >Shipping Address</v-card-title
            >
            <div
              class="user-shipping-info d-flex justify-space-between align-center flex-wrap"
            >
              <select
        ...
        <!-- d-flex justify-space-around align-center mt-4 -->
        ...
        <v-col cols="12" md="6" lg="5">
          ...
          >
            ...
            >
              <div
                class="product-img cart d-flex flex-column justify-center align-center"
                style="width: 20%"
              >
                <v-badge :content="item.quantity" color="grey-darken">
                  <img
                    :src="item.thumbnail"
                    alt=""
                    srcset=""
              ...
              <div class="cart-title" style="width: 60%">
                <v-card-title
                  style="
                    font-size: 14px;
                    font-weight: 700;
            ...
            <div
              class="discount-code w-100 d-flex justify-space-between align-center mt-3"
            >
              <input
                type="text"
                name="navSearch"
...
export default {
  data() {
    return {
      ...
      countries: [
        ...
        {
          name: "United States",
          district: ["Califonia", "Vegas", "Los Angles"],
        },
      ],
      selectedCountry: "",
    };
  ...
  methods: {
    successPaid() {
      toast.success(
        "Success Order Please Check your downloads for the receipt",
        {
          autoClose: 4000,
        }
      );
