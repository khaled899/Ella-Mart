<template>
  <div class="quality-features bg-grey-lighten-3 py-12 mt-5">
    <v-container fluid>
      <v-row>
        <v-col v-for="card in cards" :key="card.title">
          ...
          >
            <div class="parent">
              ...
              <v-card-title style="font-weight: 500" class="py-3">{{
                card.title
              }}</v-card-title>
