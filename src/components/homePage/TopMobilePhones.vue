<template>
  <div class="top-mobile-phones mt-5">
    <v-container fluid>
      <div
        class="top-mobile-phones-title d-flex align-center justify-space-between mb-7"
      >
        <h2>Top Mobile Phones</h2>
        <a href="/category/smartphones/Smartphones">Show All</a>
      </div>
      <Swiper
      ...
      >
        <swiper-slide v-for="product in mobilePhones" :key="product.id">
          <v-skeleton-loader
            v-if="loading"
...
export default {
  ...
  computed: {
    ...mapState(productModule, ["mobilePhones"]),
  },
  methods: {
    ...mapActions(productModule, ["getTopMobilePhones"]),
