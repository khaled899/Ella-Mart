<template>
  <div class="top-mens-watches mt-5">
    <v-container fluid>
      <div
        class="top-mens-watches-title d-flex align-center justify-space-between mb-7"
      >
        <h2>Top Mens Watches</h2>
        <a href="/category/mens-watches/Mens Watches">Show All</a>
      </div>
      <Swiper
      ...
      >
        <swiper-slide v-for="product in mensWatch" :key="product.id">
          <v-skeleton-loader
            v-if="loading"
...
export default {
  ...
  computed: {
    ...mapState(productModule, ["mensWatch"]),
  },
  methods: {
    ...mapActions(productModule, ["getTopMensWatches"]),
